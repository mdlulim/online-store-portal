# Mdu Admin Dashboard: React.js, Vite, Material UI - Dark & Light Mode

Welcome to Mdu Admin Dashboard, a sleek and feature-rich solution built with React.js, Vite, and Material UI, offering both dark and light mode themes. Empower your project with 11 meticulously crafted pages, including data management, user interaction, and insightful chart displays.
...
We welcome contributions and feedback from the community to enhance and improve Mdu Admin Dashboard further. Feel free to submit pull requests or open issues for any suggestions or bug reports.

## Free to Use

Mdu Admin Dashboard is open-source and completely free to use. Download it, customize it, and streamline your operations with ease.
...
**Enjoy building awesome projects with Mdu Admin Dashboard!**